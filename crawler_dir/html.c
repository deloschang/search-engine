...
Description: Given an HTML string buffer, the URL of the HTML,
...
provided as a utility for the TinySearchEngine. This function
...
is reached. The return value of this function is the
